...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-13T11:24:12+00:00",
...
此範例透過 .NET 的基本代理實現，探索 Microsoft Agent Framework 的核心概念。您將學習核心代理模式，並了解智能代理如何在 C# 和 .NET 生態系統中運作。
...
此範例展示了 Microsoft Agent Framework 與其他代理框架的對比：
...
查看 [`02-dotnet-agent-framework.cs`](../../../../02-explore-agentic-frameworks/code_samples/02-dotnet-agent-framework.cs) 以獲取完整代碼。
