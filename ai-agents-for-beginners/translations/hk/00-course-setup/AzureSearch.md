...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-07T08:27:46+00:00",
...
6. 點擊 **查看 + 創建**。
7. 查看設置並點擊 **創建** 以創建搜索服務。

## 步驟 3：開始使用 Azure AI Search

1. 部署完成後，前往 Azure 入口網站中的搜索服務。
2. 在搜索服務概覽面板中，複製 URL。它應該類似於 `https://<service-name>.search.windows.net`。
3. 在設置 > 密鑰面板中，複製查詢密鑰。
...
Azure AI Search 可與多種工具集成，以增強您的搜索功能。您可以使用 Azure CLI、Python SDK、.NET SDK 和其他工具進行高級配置和操作。
...
3. 將 Azure AI Search 實例的端點和 API 密鑰存儲到環境變量中。
