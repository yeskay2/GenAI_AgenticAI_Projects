...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-07T09:55:14+00:00",
...
此筆記本展示了使用 Microsoft Agent Framework 和 GitHub 模型在 .NET 中構建智能代理的企業級規劃與設計模式。您將學習如何創建能分解複雜問題、規劃多步解決方案並執行複雜工作流程的代理，並結合 .NET 的企業功能。
