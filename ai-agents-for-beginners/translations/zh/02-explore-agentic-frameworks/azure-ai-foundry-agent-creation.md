...
2. 项目创建完成后，关闭任何弹出的提示，查看 Azure AI Foundry 门户中的项目页面，页面应类似下图：
    ...
    ![Azure AI Foundry Project](../../../translated_images/zh/azure-ai-foundry.88d0c35298348c2f.webp)
...
3. 在列表中搜索 `gpt-4o-mini` 模型，选择并确认部署。
    ...
    ![Model Deployed](../../../translated_images/zh/model-deployment.3749c53fb81e18fd.webp)
...
![Agent Setup](../../../translated_images/zh/agent-setup.9bbb8755bf5df672.webp)
...
2. 在 **Playground** 面板中，您可以通过聊天窗口输入查询与 agent 互动。例如，您可以让 agent 查询 28 号从西雅图到纽约的航班。
    ...
    ![Agent Playground](../../../translated_images/zh/agent-playground.dc146586de715010.webp)
