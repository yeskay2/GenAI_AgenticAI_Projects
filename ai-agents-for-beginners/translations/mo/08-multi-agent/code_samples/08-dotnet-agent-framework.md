...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-07T09:14:06+00:00",
...
本筆記本展示如何使用 Microsoft Agent Framework 和 GitHub Models 在 .NET 中構建高級企業級多代理系統。您將學習如何通過結構化的工作流程協調多個專業代理，利用 .NET 的企業功能來實現生產就緒的解決方案。
